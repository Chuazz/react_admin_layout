...
const SideBar = ({ className = 'container', items, brand }: SidebarProps) => {
   ...
   return (
      <Layout>
         <div className={clsx(styles[className], styles.container, 'h-3 pt-16 pb-16 relative')}>
            <motion.div className={clsx(styles.header, "pt-8")}>
               <motion.div
                  className={clsx('row ali-center pl-12 pr-12 pb-12 pt-8 pointer grayscale-10 ')}
